  ...
  return (
    <div className="h-[80vh] w-full px-10 py-10 flex justify-evenly items-center flex-grow">
      <div className="h-full w-1/2">
        ...
        className="h-full w-3/4 rounded-full mx-auto" />
      </div>
      ...
      <div className="h-full w-1/2">
        ...
        <label>UI/UX</label>
        <input type="range" value={valueOne} onChange={handleChange}  className="range h-auto w-full m-2 orange-500" />
        <label>Development</label>
        <input type="range" value={valueTwo} onChange={handleChange} className="range h-auto w-full m-2 bg-orange-500" />
        <label>Web Design</label>
        <input type="range" value={valueThree} onChange={handleChange} className="range h-auto w-full m-2 bg-orange-500" />
        <label>Graphics Design</label>
        <input type="range" value={valueFour} onChange={handleChange} className="range h-auto w-full m-2 bg-orange-500" />
      </div> 
    </div>
  );
}