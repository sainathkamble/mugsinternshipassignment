...
export const Services = () => {
  return (
    <div className="h-[60vh] w-full px-10 py-10">
      ...
      <div className="h-[40vh] w-full m-4 flex justify-evenly items-center gap-4">
        {
          [
            ...
            <div key={key} className="h-full w-auto p-4 rounded-md bg-gray-300 grid grid-cols-1 gap-5">
               <FontAwesomeIcon icon={icon}  className="h-1/5 w-full text-8xl text-orange-500 flex justify-center items-center"/>
